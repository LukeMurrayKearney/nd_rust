...
## 17-20
taus = [3*i/(7*k_hat) for i in range(1,21)]

for sim_num in range(17,21):
    for i, data in enumerate(datas):
        for j, model in enumerate(models):
            ...
            for index, tau in enumerate(taus):
                ...
                with open(f'../output_data/simulations/big/sellke/{data}_{model}_{index}_{scales[0]}_{sim_num}_new.json','w') as f:
                    json.dump(result, f)
