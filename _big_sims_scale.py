...
## a1
taus = [np.arange(np.arange(0.0005,0.1,0.0005)), np.arange(0.1,0.6,0.01)]
...
## attempt 10
# taus = [np.arange(np.arange(0.0005,0.02,0.0005)), np.arange(0.1,0.3,0.01)]
...
with open(f'../output_data/simulations/big/fixed/{data}_{model}_{scale}.json', 'w') as file:
